...
public class Check {
	public String[] partener(String username) throws Exception/*SQLException, ClassNotFoundException*/ {
		...
		String user_name = username;
	     ...
	     // Execute a statement
	     ResultSet resultSet = statement.executeQuery("select serviceID from Provider where name='"+user_name+"'");
