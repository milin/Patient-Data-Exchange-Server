...
public class PatientDataExchange { 	
			...
			String patientID , String transmitType)
	{
		...
		IP_destination="10.10.10.10";  // Demo Data it must get from patient provider ip address.
		hospitalID="ddd";
	...
	public boolean checkLoginStaff(String username,String password){
		...
		boolean result = this.checkLogin(username, password, "ProviderStaff");
				
		return result;
	}
	
	public boolean checkLoginPersonal(String username,String password){
		
		boolean result = this.checkLogin(username, password, "Personal");
