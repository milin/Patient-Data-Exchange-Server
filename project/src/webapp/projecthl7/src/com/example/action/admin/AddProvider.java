...
public class AddProvider extends Action{
    ...
    //	register.setCreatedOn(new Date());
	...
	//	register.setContactName(contactName);
		...
		try{
			...
			//check username
			Query query=session.createQuery("from Provider p where p.username=:username");
			query.setString("username", username);
			user = (Provider) query.uniqueResult();
			if(user!=null){
				ActionErrors errors=new ActionErrors();
