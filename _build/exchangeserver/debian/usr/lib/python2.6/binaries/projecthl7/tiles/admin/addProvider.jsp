...
<form id="addAdminProvider" method="post" action="addAdminProvider.do">
<fieldset>
<div class="errorMessages"><html:errors /></div>
<br>
<p><label class="inputname"> <bean:message
	key="applicationForm.hospital.name" />: </label> <input type="text"
	name="name" class="textfield small" value="${param.name}" /></p>
<p><label class="inputname"> <bean:message
...
<p><label class="inputname"> <bean:message
	...
	name="phone1" value="${param.phone1}" style="textfield1 small1"
	maxlength="11" id="phone1">-<input type="text" name="phone2"
	value="${param.phone2}" maxlength="3" size="5" style="textfield1 small2">
</p>
<p><label class="inputname"> <bean:message
