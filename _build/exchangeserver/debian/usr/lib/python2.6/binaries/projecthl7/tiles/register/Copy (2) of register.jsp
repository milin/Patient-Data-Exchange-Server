...
<table width="100%" border=0" bgcolor="#FFFFFF">
	...
	<tr>
		<td align="center">
			<form id="addHospital" method="post" action="addHospital.do">
						...
						<td>
							<table width="100%" border="0"  cellpadding="1" cellspacing="1">
								<tr>
									...
									<td width="55%" valign="top" align="left"><input type="text" name="name" value="${param.name}"/></td>
								</tr>
								<tr>
									<td ></td>
								...
								<tr>
									...
									<td valign="top"><bean:message key="applicationForm.hospital.add"/></td>
									<td valign="top" align="left"><select style="width:150px" name="city" id="city">
									...
									<input type="text" name="city" value="${param.city}"/></td>
								</tr>
								<tr>
									<td ></td>
