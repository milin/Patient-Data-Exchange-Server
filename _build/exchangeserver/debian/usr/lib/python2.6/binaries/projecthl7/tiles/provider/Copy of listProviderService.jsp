							...
							<td>
								...
								<table border="1" width="100%" cellpadding="1" cellspacing="1" >
									<tr>
										...
										<td align="center" width="10%"><bean:message key="applicationForm.hospital.addProvider"/></td>
										<!--<td align="center" width="15%"><bean:message key="applicationForm.hospital.addStatus"/></a></td>--></tr>
											...
											<td align="center">${providerService.status}
												<c:choose>
												     <c:when test="${providerService.status == 1}" >
												      	<a href="addProviderService.do?idPs=${providerService.id}">connect</a>
												     </c:when>
												     <c:when test="${providerService.status == 2}" >
												      	<a href="addProviderService.do?idPs=${providerService.id}">No connect</a>
												     </c:when>
 												</c:choose>
											</td>
											</tr>
