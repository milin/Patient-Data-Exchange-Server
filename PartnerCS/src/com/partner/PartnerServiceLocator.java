...
public class PartnerServiceLocator extends org.apache.axis.client.Service implements com.partner.PartnerService {
    ...
    public com.partner.Partner getPartner(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.partner.PartnerSoapBindingStub _stub = new com.partner.PartnerSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.partner.Partner.class.isAssignableFrom(serviceEndpointInterface)) {
                com.partner.PartnerSoapBindingStub _stub = new com.partner.PartnerSoapBindingStub(new java.net.URL(Partner_address), this);
                _stub.setPortName(getPartnerWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://partner.com", "PartnerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://partner.com", "Partner"));
        }
